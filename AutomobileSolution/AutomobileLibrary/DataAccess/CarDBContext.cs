...
namespace AutomobileLibrary.DataAccess
{
    public class CarDBContext
    {
        ...
        {
            new Car { CarID=1,CarName="CRV",Manufacturer="Honda", Price=30000, ReleaseYears=2021 },
            new Car { CarID=2,CarName="Ford Focus",Manufacturer="Ford", Price=15000, ReleaseYears=2020 }
        };
